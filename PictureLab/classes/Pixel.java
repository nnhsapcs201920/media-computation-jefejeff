...
public class Pixel
{
    ...
    /**
     * Method to get the hue of a pixel object
     * 
     * @param r     the red value of the pixel object
     * @param g     the green value of the pixel object
     * @param b     the blue value of the pixel object
     * 
     * @return      the hue of the pixel object
     */
    ...
    /**
     * Method to get the brightness of a pixel object
     * 
     * @param r     the red value of the pixel object
     * @param g     the green value of the pixel object
     * @param b     the blue value of the pixel object
     * 
     * @return      the brightness of the pixel object
     */
    public double getBrightness(int r, int g, int b)
    {
        double brightness;
        brightness = (double)(0.2126*r) + (double)(0.7152*g) + (double)(0.0722*b);
        return brightness;
    }
}
